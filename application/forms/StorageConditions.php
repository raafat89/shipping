...
class Atlas_Form_StorageConditions extends Zend_Form {
    ...
    public function init() {
        ...
        /* HIDDEN FORM FIELDS *************************** */
        $field = new Zend_Form_Element_Hidden("storage_condition_id");
        $field->setDecorators(array('ViewHelper'));
        $this->addElement($field);

        /* TEXT FIELD FOR UNIT LABEL ************ */
        $field = new Zend_Form_Element_Text("storage_condition");
